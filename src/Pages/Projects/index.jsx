    ...
    <div className="w-full min-h-screen bg-gradient-to-b from-[#5271FF] via-purple-500 to-pink-500">
      <div className="w-[90%] mx-auto">
        <div className="p-3 flex items-center">
          ...
          <Link to="/" className="text-2xl  p-2 px-6 rounded-xl text-white font-extrabold bg-gradient-to-b from-[#ff52e5] via-purple-500 to-pink-500">{"<--"}</Link>
          <h1 className="text-center text-5xl font-bold w-[90%] text-white">ALL PROJECT'S</h1>
        </div>
