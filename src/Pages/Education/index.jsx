        ...
        <div className="w-[85%] mt-20 mx-auto flex items-center">
          <div className="w-full" data-aos="fade-right">
            <h1 className="text-4xl font-bold">
              Hi, I'm <span className="bg-gradient-to-bl from-[#5271FF] via-purple-500 to-pink-500 inline-block bg-clip-text text-transparent">Ayan Sheikh</span>.{" "}
              <br />{" "}
        ...
        <div className="w-[95%] mx-auto" data-aos="fade-up">
          ...
          <div className="w-full p-3">
            ...
            <ul className="list-disc p-2">
              <li>I successfully completed my matriculation with an A-ONE grade in
              May 2022. I have a particular interest in the field of computer
              science. Demonstrating excellent performance and understanding in
              this field, I cleared my matriculation exams. My goal is to
              further enhance my knowledge and skills in computer science and
              utilize this hard work for my future endeavors.</li>
            </ul>
          </div>
          <div className="w-full p-3">
            <h1 className="text-lg font-semibold">Intermediate</h1>
            <ul className="list-disc p-2">
                <li>As of now, I am currently pursuing my intermediate studies,
              specializing in computer science. My academic journey has been
              marked by a strong commitment to understanding the intricacies of
              this field, and I am actively engaged in coursework that enhances
              my knowledge and skills. </li>
              <li>I am maintaining a dedicated
              approach to my studies, consistently striving for excellence and
              aiming for a strong academic standing. Through my coursework and
              practical experiences, I am developing a robust foundation in
              computer science, which I plan to leverage for future academic and
              professional endeavors. I am excited about the learning
              opportunities ahead and am eager to contribute to the field of
              computer science in the future</li>
          ...
          <div className="w-full p-3">
            ...
            <ul className="list-disc p-2">
              ...
              <li>That's impressive! Completing a MERN Stack course with Saylani
              Mass IT Training (SMIT) indicates a strong commitment to enhancing
              your skills in web development. The MERN Stack, which stands for
              MongoDB, Express.js, React.js, and Node.js, is a powerful
              combination for building modern and dynamic web applications.</li> 
              <li>
              ...
              as a strong asset as you apply your skills to real-world projects
              or pursue further opportunities in the world of IT.
